...
{
    Task<Result<ProgramOutput>> CreateProgramAsync(CreateProgramInput input, CancellationToken ct);
    ...
    Task<Result<ProgramOutput>> UpdateProgramAsync(UpdateProgramInput input, CancellationToken ct);
